...
interface EventFormPanelProps {
  ...
  startTime: string;
  endTime: string;
  handleStartTimeChange: (_e: ChangeEvent<HTMLInputElement>) => void;
  handleEndTimeChange: (_e: ChangeEvent<HTMLInputElement>) => void;
...
export default function EventFormPanel(props: EventFormPanelProps) {
  const {
    editingEvent,
    title,
    setTitle,
