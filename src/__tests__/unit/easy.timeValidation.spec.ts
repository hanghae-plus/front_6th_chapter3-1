...
describe('getTimeErrorMessage - 일정 시간 유효성 검증', () => {
  describe('시간 순서가 잘못된 경우', () => {
    it('시작 시간(15:00)이 종료 시간(14:00)보다 늦을 때 양쪽 모두 에러 메시지를 반환한다', () => {
    ...
    it('시작 시간(14:00)과 종료 시간(14:00)이 같을 때 양쪽 모두 에러 메시지를 반환한다', () => {
  ...
  describe('시간 순서가 올바른 경우', () => {
    it('시작 시간(14:00)이 종료 시간(15:00)보다 빠를 때 에러 메시지를 반환하지 않는다', () => {
  ...
  describe('입력값이 비어있는 경우', () => {
    it('시작 시간이 비어있을 때 에러 메시지를 반환하지 않는다', () => {
      const result = getTimeErrorMessage('', '15:00');
      expect(result.startTimeError).toBeNull();
      expect(result.endTimeError).toBeNull();
    });

    it('종료 시간이 비어있을 때 에러 메시지를 반환하지 않는다', () => {
