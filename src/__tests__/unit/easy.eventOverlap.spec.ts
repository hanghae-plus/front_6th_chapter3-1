...
describe('isOverlapping', () => {
  const event1: Event = { id: '1', title: 'Event 1', date: '2025-07-21', startTime: '10:00', endTime: '12:00', description: '', location: '', category: '개인', repeat: { type: 'none', interval: 1 }, notificationTime: 10 };
...
describe('findOverlappingEvents', () => {
  const existingEvents: Event[] = [
    { id: '1', title: 'Event 1', date: '2025-07-21', startTime: '10:00', endTime: '12:00', description: '', location: '', category: '개인', repeat: { type: 'none', interval: 1 }, notificationTime: 10 },
    { id: '2', title: 'Event 2', date: '2025-07-21', startTime: '13:00', endTime: '14:00', description: '', location: '', category: '개인', repeat: { type: 'none', interval: 1 }, notificationTime: 10 },
    { id: '3', title: 'Event 3', date: '2025-07-21', startTime: '11:30', endTime: '12:30', description: '', location: '', category: '개인', repeat: { type: 'none', interval: 1 }, notificationTime: 10 },
  ];

  it('새 이벤트와 겹치는 모든 이벤트를 반환한다', () => {
    const newEvent: Event = { id: '4', title: 'New Event', date: '2025-07-21', startTime: '11:00', endTime: '13:00', description: '', location: '', category: '개인', repeat: { type: 'none', interval: 1 }, notificationTime: 10 };
    const overlapping = findOverlappingEvents(newEvent, existingEvents);
    expect(overlapping.map(e => e.id)).toEqual(['1', '3']);
  });

  it('겹치는 이벤트가 없으면 빈 배열을 반환한다', () => {
    const newEvent: Event = { id: '4', title: 'New Event', date: '2025-07-21', startTime: '15:00', endTime: '16:00', description: '', location: '', category: '개인', repeat: { type: 'none', interval: 1 }, notificationTime: 10 };
    const overlapping = findOverlappingEvents(newEvent, existingEvents);
    expect(overlapping).toEqual([]);
  });

  it('수정 중인 이벤트는 겹침 검사에서 제외되어야 한다', () => {
    const updatingEvent: Event = { id: '1', title: 'Event 1 Updated', date: '2025-07-21', startTime: '11:45', endTime: '12:15', description: '', location: '', category: '개인', repeat: { type: 'none', interval: 1 }, notificationTime: 10 };
