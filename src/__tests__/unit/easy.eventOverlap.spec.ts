...
describe('parseDateTime 함수', () => {
  describe('정상적인 입력값 처리', () => {
    test('2024-07-01 14:30을 정확한 Date 객체로 변환한다', () => {
  ...
  describe('잘못된 날짜 형식 처리', () => {
    test('잘못된 날짜 형식에 대해 Invalid Date를 반환한다', () => {
      const result = parseDateTime('2025 /08/19', '14:30');
      expect(result.toString()).toBe('Invalid Date');
    });

    test('잘못된 시간 형식에 대해 Invalid Date를 반환한다', () => {
      const result = parseDateTime('2025-08-19', '23:542343');
      expect(result.toString()).toBe('Invalid Date');
    });

    test('날짜 문자열이 비어있을 때 Invalid Date를 반환한다', () => {
...
describe('convertEventToDateRange', () => {
  test('일반적인 이벤트를 올바른 시작 및 종료 시간을 가진 객체로 변환한다', () => {
    const event: Event = {
      id: '1',
      date: '2025-08-19',
      startTime: '14:30',
  ...
  test('잘못된 날짜 형식의 이벤트에 대해 Invalid Date를 반환한다', () => {
    const event: Event = {
      id: '1',
      date: '2025/08/231',
      startTime: '04:30',
  ...
  test('잘못된 시간 형식의 이벤트에 대해 Invalid Date를 반환한다', () => {
    const event: Event = {
      id: '1',
      date: '2025-08-19',
      startTime: '25:643',
...
describe('isOverlapping', () => {
  ...
  test('두 이벤트가 겹치지 않는 경우 false를 반환한다', () => {
    const event1: Event = {
      id: '1',
      date: '2025-08-19',
      startTime: '10:00',
