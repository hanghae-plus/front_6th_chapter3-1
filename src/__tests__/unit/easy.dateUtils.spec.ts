...
describe('isDateInRange', () => {
  it('범위 내의 날짜 2025-07-10에 대해 true를 반환한다', () => {
    expect(isDateInRange(new Date(2025, 6, 10), new Date(2025, 6, 10), new Date(2025, 6, 10)));
    expect(isDateInRange(new Date(2025, 6, 10), new Date(2025, 6, 7), new Date(2025, 6, 17)));
  });

  it('범위의 시작일 2025-07-01에 대해 true를 반환한다', () => {
    expect(isDateInRange(new Date(2025, 6, 1), new Date(2025, 6, 1), new Date(2025, 6, 30)));
  });

  it('범위의 종료일 2025-07-31에 대해 true를 반환한다', () => {
    expect(isDateInRange(new Date(2025, 6, 30), new Date(2025, 6, 1), new Date(2025, 6, 30)));
  });

  it('범위 이전의 날짜 2025-06-30에 대해 false를 반환한다', () => {
    expect(isDateInRange(new Date(2025, 5, 30), new Date(2025, 6, 1), new Date(2025, 6, 30)));
  });

  it('범위 이후의 날짜 2025-08-01에 대해 false를 반환한다', () => {
    expect(isDateInRange(new Date(2025, 7, 1), new Date(2025, 6, 1), new Date(2025, 6, 30)));
  });

  it('시작일이 종료일보다 늦은 경우 모든 날짜에 대해 false를 반환한다', () => {
    expect(isDateInRange(new Date(2025, 5, 30), new Date(2025, 8, 1), new Date(2025, 6, 30)));
    expect(isDateInRange(new Date(2025, 7, 30), new Date(2025, 8, 1), new Date(2025, 6, 30)));
    expect(isDateInRange(new Date(2025, 9, 30), new Date(2025, 8, 1), new Date(2025, 6, 30)));
  });
});
...
describe('formatDate', () => {
  it('날짜를 YYYY-MM-DD 형식으로 포맷팅한다', () => {
    expect(formatDate(new Date(2025, 11, 13))).toBe('2025-12-13');
  });

  it('day 파라미터가 제공되면 해당 일자로 포맷팅한다', () => {
    expect(formatDate(new Date(2025, 11, 13), 30)).toBe('2025-12-30');
  });

  it('월이 한 자리 수일 때 앞에 0을 붙여 포맷팅한다', () => {
    expect(formatDate(new Date(2025, 6, 13), 30)).toBe('2025-07-30');
  });
