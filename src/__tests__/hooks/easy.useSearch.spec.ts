...
it('검색어가 비어있을 때 모든 이벤트를 반환해야 한다', () => {
  const events = [
    ...
    createTestEvent({ id: '2', title: '이벤트 2', date: '2025-07-02' }),
    createTestEvent({ id: '3', title: '이벤트 3', date: '2025-07-03' }),
  ];
...
it('검색어에 맞는 이벤트만 필터링해야 한다', () => {
  const events = [
    createTestEvent({ id: '1', title: '회의', date: '2025-07-01' }),
    createTestEvent({ id: '2', title: '점심', date: '2025-07-02' }),
    createTestEvent({ id: '3', title: '회의 빠지고 점심', date: '2025-07-03' }),
  ];
...
it('검색어가 제목, 설명, 위치 중 하나라도 일치하면 해당 이벤트를 반환해야 한다', () => {
  const events = [
    createTestEvent({ id: '1', title: '회의', description: '', location: '' }),
    createTestEvent({
      id: '2',
      title: '점심',
      description: '회의 후 점심',
...
it('현재 뷰(주간/월간)에 해당하는 이벤트만 반환해야 한다', () => {
  const events = [
    createTestEvent({ id: '1', title: '이번 주 이벤트', date: '2025-07-01' }),
    createTestEvent({ id: '2', title: '다음 주 이벤트', date: '2025-07-08' }),
    createTestEvent({ id: '3', title: '다음 달 이벤트', date: '2025-08-01' }),
  ];
...
it("검색어를 '회의'에서 '점심'으로 변경하면 필터링된 결과가 즉시 업데이트되어야 한다", () => {
  const events = [
    createTestEvent({ id: '1', title: '회의', date: '2025-07-01' }),
    createTestEvent({ id: '2', title: '점심', date: '2025-07-02' }),
    createTestEvent({ id: '3', title: '회의 하면서 점심', date: '2025-07-03' }),
  ];
