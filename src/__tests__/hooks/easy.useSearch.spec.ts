...
const mockEvents: Event[] = [
  { id: '1', title: '주간 회의', date: '2025-07-21', startTime: '10:00', endTime: '11:00', description: '팀 미팅', location: '회의실 A', category: '업무', repeat: { type: 'none', interval: 1 }, notificationTime: 10 },
  { id: '2', title: '점심 약속', date: '2025-07-22', startTime: '12:00', endTime: '13:00', description: '친구와 식사', location: '레스토랑 B', category: '개인', repeat: { type: 'none', interval: 1 }, notificationTime: 10 },
  { id: '3', title: '프로젝트 마감', date: '2025-08-01', startTime: '09:00', endTime: '18:00', description: '보고서 제출', location: '사무실', category: '업무', repeat: { type: 'none', interval: 1 }, notificationTime: 10 },
];
...
describe('useSearch', () => {
  ...
  it('검색어가 제목, 설명, 위치 중 하나라도 일치하면 해당 이벤트를 반환해야 한다', () => {
    const { result: resultTitle } = renderHook(() => useSearch(mockEvents, currentDate, 'month'), {});
